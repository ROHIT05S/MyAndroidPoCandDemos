...
public class GETAPIRequest
{
    ...
    public String request(final Context context, final FetchDataListener listener, final String ApiURL) throws JSONException
    {
        if (listener != null) {
                        ...
                        try {
                            if (listener != null) {
                                if(response.has("response")) {
                                   ...
                                   // Log.d("respGEtAPIRqst",getResponse);
...
//        Log.d("respGEtAPIRqst82",getResponse);
        return getResponse;
    }
    }
