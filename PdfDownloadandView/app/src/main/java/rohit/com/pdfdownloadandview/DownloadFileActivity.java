package rohit.com.pdfdownloadandview;
...
//    private static String file_url = "https://api.androidhive.info/progressdialog/hive.jpg";
    private static String file_url = "http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf";
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            pdfOpenintent.setDataAndType(path,imagePath);
            Log.d("fileo","open");
            try {
